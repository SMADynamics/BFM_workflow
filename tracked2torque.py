...
def tracked_2_torque(trckd_file='', 
    ...
    xy2tq = xy2torque.XY_2_Torque(tr2xy.x, 
                                  ...
                                  rm_drift_wins=rm_drift_wins, 
                                  rm_drift_mode=rm_drift_mode,
                                  rm_drift_polyfit_deg=rm_drift_polyfit_deg,
                                  rm_drift_qty=rm_drift_qty,
                                  rm_drift_qty_funct=rm_drift_qty_funct,
                                  rm_drift_plots=rm_drift_plots,
                                  rm_drift_rmregions=rm_drift_rmregions,
                                  rm_drift_rmregions_thr=rm_drift_rmregions_thr,
                                  rm_drift_rmregions_extend=rm_drift_rmregions_extend,
