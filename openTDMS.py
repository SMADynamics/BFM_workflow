...
def tdms_Trckd_to_pydic(path='', filelist=[], inspect=True, include_ROI0=False, plot_sub=100, stator='WT', dbead_nm=1000, nm_per_pix=91.3, strain='MT02 deltaCheBR'):
    ...
    cont = input(f'tdms_Trckd_to_pydic(): Trckd.tms files tot = {totsize/1e9} GB. Continue [Y]? : ')
    if cont == '': cont = 'Y'
    if cont != 'Y': return
